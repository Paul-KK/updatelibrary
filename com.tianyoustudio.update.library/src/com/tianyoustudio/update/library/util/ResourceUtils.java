    ...
    public static int getResourceIdByName(Context context, String className, String name) {
        ...
        if (context == null) {
            ...
            try {
                ...
                Log.d("tianyou", "ClassNotFoundException: class=" + className + " fieldname=" + name);
            } catch (IllegalArgumentException var8) {
                Log.d("tianyou", "IllegalArgumentException: class=" + className + " fieldname=" + name);
            } catch (SecurityException var9) {
                Log.d("tianyou", "SecurityException: class=" + className + " fieldname=" + name);
            } catch (IllegalAccessException var101) {
                Log.d("tianyou", "IllegalAccessException: class=" + className + " fieldname=" + name);
            } catch (NoSuchFieldException var11) {
                Log.d("tianyou", "NoSuchFieldException: class=" + className + " fieldname=" + name);
            }
